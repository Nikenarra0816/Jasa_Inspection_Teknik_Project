<div class="container-fluid settings-profile-place">
	<div class="form-edit-profile-place">
        ...
        <input type="file" name="files" id="image" style="display: none;">
				<input type="button" name="" value="Upload New Picture" class="btn btn-default btn-upload-photo" onclick="changeProfile()">
				<input type="button" name="" value="Delete" class="btn btn-default btn-delete-photo" onclick="removeImage()">
			</div>
			...
			<div class="input-edit-profile-place">
				...
				<div class="form-group">
					<label class="text-color-main">Password</label>
